...
const CourseDetails = () => {
  ...
  // UPDATED: Replace the old enrollCourse function
  const handleEnrollClick = async () => {
    try {
      ...
      // Show QR payment form instead of redirecting to Stripe
  ...
  // NEW: Handle successful QR payment submission
  const handleQRPaymentSuccess = () => {
    ...
    navigate('/enrollment-status/' + courseData._id);
  };

  // NEW: Check enrollment status when component loads
  useEffect(() => {
      ...
      <div className="bg-[#F9ECE2] flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <button onClick={handleEnrollClick} className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium">
